 ...
 */
export const searchResultTypeSchema = z.enum(["syllabus", "question", "chapter", "user_note", "current_affairs"]);
 ...
 */
export const SEARCH_TYPE_ORDER: SearchResultType[] = ["syllabus", "chapter", "user_note", "question", "current_affairs"];
