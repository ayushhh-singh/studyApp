      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-8 text-sm text-muted-foreground sm:px-6">
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
          ...
          <nav aria-label={t("Footer.navLabel")} className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2.5">
            ...
            <Link to={`/${locale}/contact`} className="transition-colors hover:text-foreground">
              {t("Footer.contact")}
            </Link>
            <Link to={`/${locale}/terms`} className="transition-colors hover:text-foreground">
              {t("Footer.terms")}
            </Link>
            <Link to={`/${locale}/privacy`} className="transition-colors hover:text-foreground">
              {t("Footer.privacy")}
            </Link>
            <Link to={`/${locale}/refund`} className="transition-colors hover:text-foreground">
              {t("Footer.refund")}
            </Link>
            <a
