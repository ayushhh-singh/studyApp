...
export const queryKeys = {
  ...
  sukoonJourneyDetail: (slug: string) => ["sukoon", "journeys", "detail", slug] as const,
  sukoonJourneyToday: (slug: string) => ["sukoon", "journeys", "today", slug] as const,
  ...
  sukoonBillingPlans: () => ["sukoon", "billing", "plans"] as const,
  sukoonBillingState: () => ["sukoon", "billing", "subscription"] as const,
  sukoonEntitlements: () => ["sukoon", "billing", "entitlements"] as const,
  sukoonVoiceUsage: () => ["sukoon", "voice", "usage"] as const,
  sukoonCheckinStatus: () => ["sukoon", "checkins", "status"] as const,
  sukoonCheckinTrend: (type: string) => ["sukoon", "checkins", "trend", type] as const,
  sukoonInsights: () => ["sukoon", "insights"] as const,
  sukoonPrivacySummary: () => ["sukoon", "privacy", "summary"] as const,
  sukoonExportLatest: () => ["sukoon", "privacy", "export"] as const,
  sukoonExportJob: (id: string) => ["sukoon", "privacy", "export", id] as const,
  sukoonAdminCost: (days: number) => ["sukoon", "admin", "cost", days] as const,
  sukoonBetaStatus: () => ["sukoon", "beta", "status"] as const,
  sukoonAdminFeedback: (page: number) => ["sukoon", "admin", "feedback", page] as const,
