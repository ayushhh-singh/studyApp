...
export const queryKeys = {
  ...
  sukoonMeditationContext: () => ["sukoon", "meditation", "context"] as const,
  sukoonMeditationUsage: () => ["sukoon", "meditation", "usage"] as const,
  sukoonMeditationList: () => ["sukoon", "meditation", "list"] as const,
  sukoonMeditationDetail: (id: string) => ["sukoon", "meditation", "detail", id] as const,
