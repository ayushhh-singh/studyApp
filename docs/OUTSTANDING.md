...
3. **Content depth (🟠, ongoing):** A1 (finish chapter rollout), A4-followups (strict CSAT re-gate / apply pending keymaps — A4 itself is ✅ resolved via the key-provenance gate), A2 (Hindi overlay — large, low-urgency). *(A3 2021 GS-I key ✅ resolved 2026-07-15 — booklet-series fix.)*
