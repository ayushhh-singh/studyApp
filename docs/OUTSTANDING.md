...
3. **Content depth (🟠, ongoing):** A1 (finish chapter rollout), A4-followups (strict CSAT re-gate / apply pending keymaps — A4 itself is ✅ resolved via the key-provenance gate), A2-residuals (Mains-descriptive Hindi overlay + CSAT single-language sections + the option-completeness DB repair — A2 prelims-MCQ overlay ✅ done 2026-07-13). *(A3 2021 GS-I key ✅ resolved 2026-07-15 — booklet-series fix.)*
